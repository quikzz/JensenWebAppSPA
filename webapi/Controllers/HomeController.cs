    ...
    public class HomeController : ControllerBase
    {
        ...
        public HomeController(ILogger<HomeController> logger)
        {
            ...
            _articles = new List<Article>
                {
                    new Article { Title = "Inte klart med ersättare för Ribbenvik", 
                                  ...
                                  Topic = new List<string>{ "SamhalleKonflikter" } 
                                },
                    new Article { Title = "Drogs in i inhägnad – dödades av 40 krokodiler", 
                                  ...
                                  Topic = new List<string>{ "Ekonomi" } 
                                },
                    new Article { Title = "Regionpolitiker: Mer stöd från staten behövs", 
                                  ...
                                  Published = DateTime.Now.AddDays(-1), 
                                  Topic = new List<string>{ "Politik" } 
                                },
                    new Article { Title = "Två avlidna hittade i bostad i Sandviken", 
